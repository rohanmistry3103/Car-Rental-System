...
namespace CarRentalServiceManagementSystemCSharp
{
    public partial class Car : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=d:\My work\car rental project\carsourcecode\CarRentalServiceManagementSystemCSharp\carrental.mdf;Integrated Security=True");
            con.Open();
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    textBox8.Text = "";
                    textBox1.Text = "";
                    using (SqlConnection con1 = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=d:\My work\car rental project\carsourcecode\CarRentalServiceManagementSystemCSharp\carrental.mdf;Integrated Security=True"))
                    {
